...
# Parse json units with GPT-3.5 and save to a csv file
#LLMUnits = ParseUnitsWithLLM("data/dataUWA/extractedInformation/soupedUnits2023.csv")
#parsedUnits = LLMUnits.extract()
